      ...
      <section className="py-16 md:py-24 bg-section-dark">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl font-bold text-section-dark-foreground mb-4">
              {t("kurumsal.aboutCompanyName")}
            </h2>
            <p className="text-section-dark-foreground/70 leading-relaxed mb-8">
              {t("kurumsal.aboutIntro")}
            </p>
            <h4 className="font-bold text-section-dark-foreground mb-3">
            ...
            <ul className="space-y-2 mb-8">
              {(
                ...
                <li
                  key={i}
                  className="flex items-start gap-2 text-section-dark-foreground/70"
                >
